...
def summariseTopComments(comments: list[Comment]):
    ...
    return askAi(f"Summarise the following comments really well and with some expansion around 3 medium size paragraphs, showing if there are different schools of thoughts (or different patterns): {comments}")
